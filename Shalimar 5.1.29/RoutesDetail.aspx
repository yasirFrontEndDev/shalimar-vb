<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="RoutesDetail.aspx.vb" Inherits="FMovers.Ticketing.UI.RoutesDetail" %>
...
<body onload="pageInit();">
                                                ...
                                                <tr>
                                                    <td align="left" valign="middle">
                                                        <table cellpadding="0" cellspacing="0" style="width: 100%">
                                                            ...
                                                            <tr>
                                                                <td align="right" style="width: 150px">
                                                                    <asp:Label ID="Label1" runat="server" Text="Route Code:" CssClass="Generallabel"></asp:Label>&nbsp;
                                                                </td>
                                                                <td>
                                                                    <asp:TextBox ID="txtRouteID" runat="server" Width="70px" CssClass="txtbox" 
                                                                        MaxLength="40" Height="20px"></asp:TextBox>
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                <td align="right">
                                                                    <asp:Label ID="Label2" runat="server" Text="Route Name:" CssClass="Generallabel"></asp:Label>&nbsp;
                                                                </td>
                                                                <td>
                                                                    <asp:TextBox ID="txtRouteName" runat="server" Width="250px" CssClass="txtbox" 
                                                                        MaxLength="40" Height="20px"></asp:TextBox>
                                                                </td>
                                                            </tr>
                                                        </table>
    ...
    <igtbl:UltraWebGrid ID="grdRoutes" runat="server" Height="200px" Width="100%">
        <bands>
            <igtbl:UltraGridBand>
                                               ...
                                               <tr>
                                                    <td align="right" valign="middle" height="5px">                                                        
                                                        <input id="btnAdd" runat="server" value="New" class="ButtonStyle" type="button" 
                                                            Width="81px" onclick="btnAdd_onclick()" style="width: 81px;"/>&nbsp;<input 
                                                            id="btnDelete" runat="server" value="Delete" class="ButtonStyle" type="button" 
                                                            Width="81px" onclick="btnDelete_onclick()" style="width: 81px;"/>&nbsp;<asp:Button ID="btnSave" runat="server" Text="Save" CssClass="ButtonStyle" Width="81px" />&nbsp;<asp:Button ID="btnSavenClose" runat="server" Text="Save & Close" 
