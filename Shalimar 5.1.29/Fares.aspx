<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Fares.aspx.vb" Inherits="FMovers.Ticketing.UI.Fares" %>
    ...
    <div>
                                            ...
                                            <table width="90%" align="center" border="0" class="TableBorder" cellspacing="0">
                                                <tr class="HeaderStyle">
                                                    <td align="left" valign="middle">Fare Detail</td>
                                                </tr>                                                
                                                <tr >
                                                    <td align="left" valign="middle">
                                                        <table class="style1">
                                                            <tr>
                                                                <td width ="150px">
                                                                  Select Service Type :    &nbsp;</td>
                                                                <td>
                                                                    <asp:DropDownList ID="cboServiceType" runat="server" AutoPostBack="True">
                                                                    </asp:DropDownList>
                                                                </td>
                                                            </tr>
                                                        </table>
