<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/main.Master" CodeBehind="DropTimeUI.aspx.vb" Inherits="FMovers.Ticketing.UI.DropTimeUI" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1"  runat="server">
     ...
     <script language=javascript >
         function loadreport() {
             ...
             window.open('Reports/DropTimeReport.aspx?from=' + document.getElementById("ctl00_ContentPlaceHolder1_dtFrom_input").value + "&to=" + document.getElementById("ctl00_ContentPlaceHolder1_dtTo_input").value);
             return false;
  ...
  <div class="topRow">
    ...
    <table width="600px" align="center" border="0" class="TableBorder" cellspacing="0">
         <tr>
            <td align="center"  class="HeaderStyle">Drop Time Report</td>
