<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Transit.aspx.vb" Inherits="FMovers.Ticketing.UI.Transit" %>
...
<head id="Head1" runat="server">
   ...
   <link rel="stylesheet" href="styles/jquery.ui.all.css">
	...
	<script>
	    function hideme() {
	        document.getElementById("TransitTable").style.display = 'none';
	        document.getElementById("Pleasewait").style.display = 'block';
	         
	    
	    }
	    function LoadActualVoucher(VoucherId) {
	        //alert(VoucherId);
	        parent.reLoadWidow(VoucherId);
	    }
	</script>
	<link rel="stylesheet" href="styles/demos.css">
...
<div class="ui-widget">            
         ...
         <tr>
             <td colspan="9">
                 <table class="style1" id="TransitTable">
                     <tr>
                         <td colspan="2">
                                                                    <asp:Label ID="lblGenError" runat="server" CssClass="Generallabel" 
                                                                        Font-Bold="True" ForeColor="Red"></asp:Label>
                                                                    <asp:Label ID="lblGenOK" runat="server" CssClass="Generallabel" 
     ...
     <asp:DropDownList ID="cboRoute" runat="server" AutoPostBack="True" Width="144px" 
                     ...
                     <tr>
                         <td>
                                                                    <asp:Label ID="Label18" runat="server" CssClass="Generallabel" 
                                                                        Text="Vechile :"  ></asp:Label>
                         </td>
                         <td>
                <asp:DropDownList ID="cboVechile" runat="server" AutoPostBack="True">
                </asp:DropDownList>
                         </td>
                     </tr>
                     <tr>
                         <td>
                                                                    &nbsp;</td>
                         <td>
                             <asp:CheckBox ID="chkPrint" runat="server" CssClass="Generallabel" 
                                 Font-Bold="True" Font-Size="XX-Small" ForeColor="Red" 
                     ...
                     <tr>
                         <td>
                                                                    &nbsp;</td>
                         <td>
                <asp:Button ID="Button2" runat="server" CssClass="ButtonStyle" Text="Transit" 
                                 onclientclick="return hideme();" />
            &nbsp;<asp:Button ID="Button3" OnClientClick="return parent.abc();" runat="server" CssClass="ButtonStyle" Text="Cancel" />
                         </td>
                     </tr>
                 </table>
             </td>
        ...
        <div id="Pleasewait" style="display:none;font-size:15px;font-weight:bold " >
