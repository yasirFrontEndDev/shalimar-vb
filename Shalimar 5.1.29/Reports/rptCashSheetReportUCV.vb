...
Public Class rptCashSheetReportUCV
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "rptCashSheetReportUCV.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "FMovers.Ticketing.UI.rptCashSheetReportUCV.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_Book_Id() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedrptCashSheetReportUCV
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptCashSheetReportUCV = New rptCashSheetReportUCV
        rpt.Site = Me.Site
        Return rpt
    End Function
