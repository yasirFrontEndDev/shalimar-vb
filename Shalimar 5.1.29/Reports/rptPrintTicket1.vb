...
Public Class rptPrintTicket
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "FMovers.Ticketing.UI.rptPrintTicket.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptPrintTicket
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptPrintTicket = New rptPrintTicket
        rpt.Site = Me.Site
        Return rpt
    End Function
