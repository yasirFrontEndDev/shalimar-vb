...
Public Class rptDailyDeparture
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "FMovers.Ticketing.UI.rptDailyDeparture.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptDailyDeparture
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptDailyDeparture = New rptDailyDeparture
        rpt.Site = Me.Site
        Return rpt
    End Function
