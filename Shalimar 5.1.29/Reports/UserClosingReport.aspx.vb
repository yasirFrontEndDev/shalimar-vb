...
Public Class UserClosingReport
...
#End Region
    ...
    Public Function CreateReport() As ReportDocument
        ...
        cReportUtility.PassParameter("@From_Date", Request.QueryString("from"), rptsrc)
        cReportUtility.PassParameter("@To_Date", Request.QueryString("to"), rptsrc)

        If objUser.LoginName = "admin" Then
            cReportUtility.PassParameter("@User_ID", 0, rptsrc)
        Else
            cReportUtility.PassParameter("@User_ID", objUser.Id, rptsrc)
        End If

        cReportUtility.PassParameter("@Departure_From", Request.QueryString("Dfrom"), rptsrc)
        cReportUtility.PassParameter("@Departure_To", Request.QueryString("Dto"), rptsrc)
