...
Public Class rptSmartCNICSheet
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "FMovers.Ticketing.UI.rptSmartCNICSheet.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptSmartCNICSheet
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptSmartCNICSheet = New rptSmartCNICSheet
        rpt.Site = Me.Site
        Return rpt
    End Function
