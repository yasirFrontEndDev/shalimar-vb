...
Public Class rptCancelSeats
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "FMovers.Ticketing.UI.rptCancelSeats.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptCancelSeats
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptCancelSeats = New rptCancelSeats
        rpt.Site = Me.Site
        Return rpt
    End Function
