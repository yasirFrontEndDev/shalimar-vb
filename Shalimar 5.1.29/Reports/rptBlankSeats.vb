...
Public Class rptBlankSeats
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "FMovers.Ticketing.UI.rptBlankSeats.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptBlankSeats
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptBlankSeats = New rptBlankSeats
        rpt.Site = Me.Site
        Return rpt
    End Function
