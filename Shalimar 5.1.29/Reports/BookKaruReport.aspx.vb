...
#End Region
    ...
    Private Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        fileName = Server.MapPath("..\TempDocument\") + "BookKaruFInal.pdf"
        ...
        Response.Redirect("loadPDF.aspx?Type=BookKaruFInal", True)
    ...
    Public Function CreateReport() As ReportDocument
        ...
        rptsrc.Load(Request.PhysicalApplicationPath & "Reports/BookKaruFInal.rpt")
        ...
        cReportUtility.PassParameter("@Route", Request.QueryString("routeid"), rptsrc)
