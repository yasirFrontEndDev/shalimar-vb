...
Public Class Crystal_Report11rptDailyDeparture
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "FMovers.Ticketing.UI.1rptDailyDeparture.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCrystal_Report11rptDailyDeparture
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Crystal_Report11rptDailyDeparture = New Crystal_Report11rptDailyDeparture
        rpt.Site = Me.Site
        Return rpt
    End Function
