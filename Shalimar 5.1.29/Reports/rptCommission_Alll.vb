...
Public Class rptCommission_Alll
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "FMovers.Ticketing.UI.rptCommission_Alll.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptCommission_Alll
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptCommission_Alll = New rptCommission_Alll
        rpt.Site = Me.Site
        Return rpt
    End Function
