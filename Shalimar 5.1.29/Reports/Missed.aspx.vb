...
#End Region
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        If Not IsPostBack Then
            ...
            fileName = Server.MapPath("..\TempDocument\") + "Missed.pdf"
            rptDoc = CreateReport()
            ...
            Response.Redirect("loadPDF.aspx?Type=Missed", True)
    ...
    Public Function CreateReport() As ReportDocument
        ...
        Try
            ...
            rptsrc.Load(Request.PhysicalApplicationPath & "Reports/MissedCash.rpt")
            cReportUtility.setConnectionInfo(rptsrc)
            cReportUtility.PassParameter("@UserId", objUser.Id, rptsrc)
            cReportUtility.PassParameter("@type", Request.QueryString("type").ToString(), rptsrc)
