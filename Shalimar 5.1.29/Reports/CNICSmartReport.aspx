<%@ Page Language="vb" AutoEventWireup="false" Codebehind="CNICSmartReport.aspx.vb" Inherits="FMovers.Ticketing.UI.CNICSmartReport" %>
			...
			<TABLE id="Table1" cellSpacing="1" cellPadding="1" width="100%" border="0" runat="server">
				...
				<TR>
					<TD align="center">
                        ...
                        <asp:Button ID="Button1" OnClientClick="javascript:printDiv();" runat="server" Text="Test" />                        
                    </TD>
				</TR>
