...
Public Class LoadreportNextDeparture
...
#End Region
    ...
    Private Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        If Not IsPostBack Then
            ...
            fileName = Server.MapPath("..\TempDocument\") + "ND.pdf"
            rptDoc = CreateReport()
            ...
            Response.Redirect("loadPDF.aspx?Type=ND", True)
    ...
    Public Function CreateReport() As ReportDocument
        ...
        rptsrc.Load(Request.PhysicalApplicationPath & "Reports/rpt_NextDeparture.rpt")
