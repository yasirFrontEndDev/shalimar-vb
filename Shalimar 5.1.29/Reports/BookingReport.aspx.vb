...
#End Region
    ...
    Private Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        fileName = Server.MapPath("..\TempDocument\") + "PhoneBookingReport.pdf"
        ...
        Response.Redirect("loadPDF.aspx?Type=PhoneBookingReport", True)
    ...
    Public Function CreateReport() As ReportDocument
        ...
        rptsrc.Load(Request.PhysicalApplicationPath & "Reports/PhoneBookingReport.rpt")
