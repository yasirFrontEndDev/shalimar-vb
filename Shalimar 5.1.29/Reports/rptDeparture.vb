...
Public Class rptDeparture
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "FMovers.Ticketing.UI.rptDeparture.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptDeparture
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptDeparture = New rptDeparture
        rpt.Site = Me.Site
        Return rpt
    End Function
