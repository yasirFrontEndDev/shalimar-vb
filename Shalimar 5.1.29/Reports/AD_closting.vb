...
Public Class AD_closting
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "FMovers.Ticketing.UI.AD_closting.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedAD_closting
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As AD_closting = New AD_closting
        rpt.Site = Me.Site
        Return rpt
    End Function
