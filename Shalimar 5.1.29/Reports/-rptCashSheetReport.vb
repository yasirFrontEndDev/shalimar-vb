...
Public Class _rptCashSheetReport
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "FMovers.Ticketing.UI.-rptCashSheetReport.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cached_rptCashSheetReport
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As _rptCashSheetReport = New _rptCashSheetReport
        rpt.Site = Me.Site
        Return rpt
    End Function
