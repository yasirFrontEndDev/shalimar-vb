...
Public Class rptCNICSheet
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "FMovers.Ticketing.UI.rptCNICSheet.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptCNICSheet
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptCNICSheet = New rptCNICSheet
        rpt.Site = Me.Site
        Return rpt
    End Function
