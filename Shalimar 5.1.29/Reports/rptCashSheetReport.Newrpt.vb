...
Public Class rptCashSheetReportNewrpt
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "rptCashSheetReport.Newrpt.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "FMovers.Ticketing.UI.rptCashSheetReport.Newrpt.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptCashSheetReportNewrpt
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptCashSheetReportNewrpt = New rptCashSheetReportNewrpt
        rpt.Site = Me.Site
        Return rpt
    End Function
