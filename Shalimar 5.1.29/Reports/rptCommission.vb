...
Public Class rptCommission
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "FMovers.Ticketing.UI.rptCommission.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptCommission
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptCommission = New rptCommission
        rpt.Site = Me.Site
        Return rpt
    End Function
