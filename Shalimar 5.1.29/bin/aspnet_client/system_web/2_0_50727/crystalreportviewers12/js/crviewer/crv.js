...
if (typeof(bobj.crv) == 'undefined') {
    ...
    bobj.crv.ActxPrintControl_Version = '12,0,0,549';
    ...
    /**
     * Fixes the issue of not rendering properly when viewer is placed inside a TABLE
     * Called from webform viewer when window is loaded 
     * 
     */
    bobj.crv.doLayout = function(viewerID) {
        if(viewerID && _ie) {
            var viewer = MochiKit.DOM.getElement(viewerID);
            if(viewer && bobj.checkParent(viewer,"TABLE")) {
                var widget = _widgets[viewer._widget];
                if (widget && widget._doLayout) {
                    widget._doLayout();
                }
            }
        }
    ...
    bobj.crv._includeAll = function() {
        ...
        if (bobj.crv.config.useCompressedScripts) {
            ...
            var scripts = [
                ...
                'bobjcallback.js',
                'Calendar.js',
                '../external/rsa/base64.js',
                '../external/rsa/jsbn.js',
                '../external/rsa/prng4.js',
                '../external/rsa/rng.js',
                '../external/rsa/rsa.js'
            ];
            // TODO Justin, do we have to include the RSA files with every request?
    ...
    // preload images
    bobj.crv.preloadImage1 = new Image ();
    bobj.crv.preloadImage1.src = bobj.crvUri ("../dhtmllib/images/skin_standard/wait01.gif");
    bobj.crv.preloadImage2 = new Image ();
    bobj.crv.preloadImage2.src = bobj.crvUri ("../dhtmllib/images/skin_standard/dialogframe.gif");
    bobj.crv.preloadImage3 = new Image ();
    bobj.crv.preloadImage3.src = bobj.crvUri ("../dhtmllib/images/skin_standard/dialogtitle.gif");
    bobj.crv.preloadImage4 = new Image ();
    bobj.crv.preloadImage4.src = bobj.crvUri ("../dhtmllib/images/skin_standard/dialogelements.gif");
}
