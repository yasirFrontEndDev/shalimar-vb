...
bobj.crv.params.ParameterValueRow._getValueHTML = function() {
    ...
    return DIV({id: this.id + '_vc', 'class': 'iactParamValue'}, this._valueWidget.getHTML());
};
...
bobj.crv.params.newScrollMenuWidget = function(kwArgs) {
    ...
    kwArgs.visibleLines = (kwArgs.originalValues.length >= kwArgs.maxVisibleItems) ? kwArgs.maxVisibleItems : kwArgs.originalValues.length;
