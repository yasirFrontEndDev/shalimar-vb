...
{
	var o=igedit_all[id],elem=(typeof document=='unknown')?null:document.getElementById('igtxt'+id);
	if(o&&o.msV)
	{
		var i=-1,b=o.buttons;
...
function igedit_mask(elem,id,prop0,prop1)
{
	...
	me.focusTxt=function(foc,e)
	{
		...
		if(e!=null&&!foc)
		{
			...
			this._vs=this.elemViewState.value=ig_csom.replace(t=this.txt,String.fromCharCode(13),String.fromCharCode(14))+((inv<0)?"":String.fromCharCode(30));
...
function igedit_new(elem,id,prop0)
{
	...
	this.doKey0=function(e,a)
	{
		...
		if(a!=1&&(e.ctrlKey||e.altKey||k==17))
		{
			...
			else if(t0!=t1&&k==86){this.paste(t1);this._np=1;}
	...
	this.doEvt=function(e)
	{
		...
		if(type>=8)
		{
			...
			else{if(this._last!=val||this.bad!=0)this.setText(val);this.update(this.postValue);}
			this.repaint();
...
function igedit_event(e)
{
	...
	if(s||u||l)
	{
		for(i in igedit_all)if((o=igedit_all[i])!=null)
		{
			...
			if(s&&o.elemViewState&&o.elemViewState.value!=o._vs)o.elemViewState.value=o._vs0;
		}
		return;
	}
