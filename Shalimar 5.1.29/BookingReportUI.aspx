<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="BookingReportUI.aspx.vb" Inherits="FMovers.Ticketing.UI.BookingReportUI" MasterPageFile="~/main.Master" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1"  runat="server">
     ...
     <script language=javascript >
      function loadreport() {
        //  alert(document.getElementById("ctl00_ContentPlaceHolder1_dtFrom_input").value);
          ...
          window.open('Reports/BookingReport.aspx?from=' + document.getElementById("ctl00_ContentPlaceHolder1_dtFrom_input").value + "&to=" + document.getElementById("ctl00_ContentPlaceHolder1_dtTo_input").value );
          return false;
  ...
  <div class="topRow">
    ...
    <table width="600px" align="center" border="0" class="TableBorder" cellspacing="0">
         <tr>
            <td align="center" class="HeaderStyle">Booking Report</td>
