<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Schedule_detail_new.aspx.vb" Inherits="FMovers.Ticketing.UI.Schedule_detail_new" %>
                                                ...
                                                <tr>
                                                    <td align="left" valign="middle">
                                                        <table cellpadding="2" cellspacing="0" width="100%">
                                                            ...
                                                            <tr>
                                                                <td align="right" width="20%">
                                                                    <asp:Label ID="Label9" runat="server" Text="SMS Mints :" 
                                                                        CssClass="Generallabel"></asp:Label>
                                                                </td>
                                                                <td width="30%">
                                                                    <asp:TextBox ID="txtSMSMints" runat="server" Width="80%" CssClass="txtbox" 
                                                                        MaxLength="40" Height="20px"></asp:TextBox>
                                                                </td>
                                                                <td align="right" width="20%">
