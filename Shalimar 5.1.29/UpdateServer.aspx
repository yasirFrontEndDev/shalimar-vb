<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="UpdateServer.aspx.vb" Inherits="FMovers.Ticketing.UI.UpdateServer" %>
...
//         
          window.open('Reports/BS.aspx?from=' + document.getElementById("dtFrom_input").value + "&to="+document.getElementById("dtTo_input").value+"&SH="+cmbSource1.options[cmbSource1.selectedIndex].value);
...
<body>
    ...
    <table width="600px" align="center" border="0" class="TableBorder" cellspacing="0">
         <tr>
            <td align="center" class="HeaderStyle">Update Server</td>
       ...
       <tr>
            <td align="right" class="">
                <asp:Button ID="btnShowReport" runat="server" Text="Update Server Data"   CssClass="ButtonStyle" Width="115px" />&nbsp; </td>
       </tr>
       <tr>
