<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Routes.aspx.vb" Inherits="FMovers.Ticketing.UI.Routes" %>
...
<body>
   ...
   <table width="90%" align="center" border="0" class="TableBorder" cellspacing="0">
                                                <tr class="HeaderStyle">
                                                    <td align="left" valign="middle">Routes</td>
                                                </tr>                                                
                                                <tr>
                    ...
                    <padding left="2px" />
                                               ...
                                               <tr>
                                                    <td align="right" valign="middle" height="5px">
                                                        ...
                                                        <asp:Button ID="btnModify" runat="server" Text="Modify" CssClass="ButtonStyle" Width="81px" />&nbsp;<asp:Button 
                                                            ID="btnDelete" runat="server" Text="Delete" CssClass="ButtonStyle" 
                                                            Width="81px" />&nbsp;</td>
                                                </tr>  
                                              </table>
