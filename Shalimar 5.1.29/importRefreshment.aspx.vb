...
Public Class importRefreshment
    Inherits System.Web.UI.Page

    Private objOnlineImport As eImportUtil
    Dim objConnection As Object
    Dim objUser As clsUser
    Dim objRefreshment As clcRefreshment
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Try
            ...
            dtOnlineRecords = objOnlineImport.GetAllRecords("TicketingRefreshment")

            objRefreshment = New clcRefreshment(objConnection)
            If Not objRefreshment Is Nothing Then
                objRefreshment.ImportAllRefreshment(dtOnlineRecords)
            Else
