<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Schedules.aspx.vb" Inherits="FMovers.Ticketing.UI.Schedules" %>
                    ...
                    <padding left="2px" />
                                               ...
                                               <tr>
                                                    <td align="right" valign="middle" height="5px"><input id="hidSchID" type="hidden" runat="server" value='' />
                                                        <input id="btnAdd" runat="server" value="Add" class="ButtonStyle" 
                                                            type="button" onclick="return btnAdd_onclick()" />
