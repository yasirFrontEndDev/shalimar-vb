<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="BookkaruPrintReport.aspx.vb" Inherits="FMovers.Ticketing.UI.BookkaruPrintReport"  MasterPageFile="~/main.Master"  %>
...
<script language=javascript >
      function loadreport() {
        //  alert(document.getElementById("ctl00_ContentPlaceHolder1_dtFrom_input").value);
          ...
          window.open('Reports/BookkaruOnlinePrintReport.aspx?from=' + document.getElementById("ctl00_ContentPlaceHolder1_dtFrom_input").value + "&to=" + document.getElementById("ctl00_ContentPlaceHolder1_dtTo_input").value +"&User_Id="+cboRoutes.options[cboRoutes.selectedIndex].value);
          return false;
  ...
  <div class="topRow">
    ...
    <table width="600px" align="center" border="0" class="TableBorder" cellspacing="0">
         <tr>
            <td align="center" class="HeaderStyle">BokKaru Online Tickets Print Report</td>
                                                        ...
                                                        <table cellpadding="2" cellspacing="1" width="90%">
                                                            ...
                                                            <tr>
                                                                <td align="right" height="5px" width="150">
                                                                    <asp:Label ID="Label4" runat="server" CssClass="Generallabel" Text="Users :"></asp:Label>
                                                                </td>
                                                                <td>
