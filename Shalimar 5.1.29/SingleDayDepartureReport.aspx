<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="SingleDayDepartureReport.aspx.vb" Inherits="FMovers.Ticketing.UI.SingleDayDepartureReport" %>
...
<body>
    ...
    <table width="600px" align="center" border="0" class="TableBorder" cellspacing="0">
         <tr>
            <td align="center" class="HeaderStyle">Single Day Departure Report</td>
...
<tr>
                                                            ...
                                                            <tr>
                                                                <td align="right" width="150"><asp:Label ID="Label1" runat="server" Text="Date:" 
                                                                        CssClass="Generallabel"></asp:Label>&nbsp;</td>
                                                                <td>
