<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Exclude_Terminal_Detail.aspx.vb" Inherits="FMovers.Ticketing.UI.Exclude_Terminal_Detail" %>
                                            ...
                                            <table width="90%" align="center" border="0" class="TableBorder" cellspacing="0">
                                                <tr class="HeaderStyle">
                                                    <td align="left" valign="middle">
                                                       Exclude Terminals Selection</td>
                                                </tr>
                                                <tr>
                                                    <td align="left" valign="middle">
                                                        <table cellpadding="2" cellspacing="0" width="100%">
                                                            ...
                                                            <tr>
                                                                <td align="right" width="20%">
                                                                    <asp:Label ID="Label6" runat="server" Text="From City :" 
                                                                        CssClass="Generallabel"></asp:Label>
                                                                </td>
                                                                <td width="30%">
                                                                    <asp:DropDownList ID="cmbFromCity" runat="server" Width="80%" 
                                                                        AutoPostBack="True">
                                                                    </asp:DropDownList>
                                                                </td>
                                                                <td align="right" width="20%">
                                                                    <asp:Label ID="Label7" runat="server" Text="To City :" 
                                                                        CssClass="Generallabel"></asp:Label>
                                                                </td>
                                                                <td width="30%"><input id="hidSchID" type="hidden" runat="server" value='0' />
                                                                    <asp:DropDownList ID="cmbToCity" runat="server" Width="80%" AutoPostBack="True">
                                                                    </asp:DropDownList>
                                                                </td>                                                                
                                                                <td width="30%"><asp:Button ID="btnLoad" runat="server" Text="Load" 
                                                                        CssClass="ButtonStyle" Width="81px" />
                                                                </td>                                                                
                                                            </tr>                                                           
                                                            <tr>
                                                                <td align="right" width="20%">
            ...
            <filteroptionsdefault>
                ...
                <filteroperanddropdownstyle backcolor="White" bordercolor="Silver" 
                    ...
                    <padding left="2px" />
                                               ...
                                               <tr>
                                                    <td align="right" valign="middle" height="5px">                                                        
                                                        &nbsp;&nbsp;<asp:Button ID="btnSave" runat="server" Text="Save" CssClass="ButtonStyle" Width="81px" />&nbsp;<asp:Button ID="btnSavenClose" runat="server" Text="Save & Close" 
